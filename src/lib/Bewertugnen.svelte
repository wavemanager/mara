    ...
    const textBlocks = [
        {
            ...
            content: '"Diese Plattform hat unsere Arbeitsweise revolutioniert! Einfach, intuitiv und unglaublich effizient." - CEO, Alpha Corp'
        },
        {
            title: 'Erfolgsgeschichte Beta',
            iconClass: 'fa-solid fa-star',
            content: '"Seit wir dieses Tool nutzen, konnten wir unsere Bearbeitungszeiten halbieren. Ein echter Gewinn!" - Manager, Beta Solutions'
        },
        {
            title: 'Meinung von Gamma',
            iconClass: 'fa-solid fa-thumbs-up',
            content: '"Der Support ist erstklassig und die Funktionen übertreffen unsere Erwartungen bei Weitem." - Nutzer, Gamma Inc.'
        }
    ];
...
<section class="relative py-16 md:py-24 bg-cover bg-center" style="background-image: url('https://images.unsplash.com/photo-1550133730-695473e544be?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1350&q=80');">
    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="flex flex-col md:flex-row items-center gap-8 md:gap-12">
            ...
            <div class="md:w-1/2">
                <div class="bg-white dark:bg-gray-800 shadow-xl rounded-xl p-6 md:p-8 overflow-hidden h-[250px] flex flex-col justify-center"> <!-- overflow-hidden ist wichtig für die Animation, min-h-[wert] um Springen zu vermeiden -->
